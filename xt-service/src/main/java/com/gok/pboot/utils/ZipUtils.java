...
public class ZipUtils {
    ...
    private static void handlerFile(ZipOutputStream zip, File file, String dir) throws Exception {
        ...
        if (file.isDirectory()) {
            ...
            //将文件夹添加到下一级打包目录
            zip.putNextEntry(new ZipEntry(dirPath.toString()));
            dir = dir.length() == 0 ? "" : dirPath.toString();
            // 递归将文件夹中的文件打包
     ...
     */
    public static void deleteFileDir(String filePath) throws IOException {
