...
public class PoiWordTools {
    ...
    public static void replaceRadarCharts(POIXMLDocumentPart poixmlDocumentPart,
                                          List<String> titleArr, List<String> fldNameArr, List<Map<String, String>> listItemsByType) throws Exception {
    ...
    public static boolean refreshExcel(XWPFChart chart,
                                       List<Map<String, String>> dataList, List<String> fldNameArr, List<String> titleArr) throws Exception{
        boolean result = true;
     ...
     * @param content
     */
    public static void setWordCellSelfStyle(XWPFTableCell cell, String content) {
        if (StringUtils.isNotBlank(content) && cell != null) {
