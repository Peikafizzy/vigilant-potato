...
public interface DictionaryCategoryMapper extends BaseMapper<DictionaryCategory> {
     ...
     */
    List<DictionaryCategoryVO> getAll(@Param("ignore") Long... ignore);
     ...
     */
    Page<DictionaryCategoryVO> find(Page<DataDictionary> page, @Param("filter") Map<String, Object> filter);
}
