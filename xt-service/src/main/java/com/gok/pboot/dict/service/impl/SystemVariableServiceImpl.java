package com.gok.pboot.dict.service.impl;

import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.gok.pboot.base.PageRequest;
import com.gok.pboot.dict.mapper.DataDictionaryMapper;
import com.gok.pboot.dict.mapper.DictionaryCategoryMapper;
...
import com.gok.pboot.platform.dict.vo.DictionaryCategoryVO;
...
public class SystemVariableServiceImpl implements ISystemVariableService {
    ...
    public DataDictionaryVO getDataDictionary(String code) {
        return dataDictionaryMapper.getVOByCode(code);
    }
    ...
    @Override
    @Cacheable(value = "dataDictionaryCache", key = "#code")
    public List<DataDictionaryVO> getDataDictionaries(String code) {
        Map<String, Object> map = new HashMap<>(2);
        map.put("categoryCode", code);
        return dataDictionaryMapper.find(map);
    }
...
//            String parentCode = parent.getCode();
     ...
     */
    @Override
    public Page<DataDictionaryVO> findDataDictionaries(PageRequest pageRequest, Map<String, Object> filter) {
     ...
     */
    @Override
    public List<DictionaryCategoryVO> getAllDictionaryCategories(Long... ignore) {
     ...
     */
    @Override
    public Page<DictionaryCategoryVO> findDictionaryCategories(PageRequest pageRequest, Map<String, Object> filter) {
