package com.gok.pboot.dict.util;
...
public class VariableUtils {
     ...
     * 默认字典值的值名称
     */
    public final static String DEFAULT_VALUE_NAME = "name";
    /**
     * 默认字典值的键名称
     */
    ...
    public static List<Map<String,Object>> get(String code, Object... ignore) {
        List<Map<String,Object>> result = Lists.newArrayList();
        List<DataDictionaryVO> dataDictionaries = systemVariableService.getDataDictionaries(code);

        for (DataDictionaryVO data : dataDictionaries) {
     ...
     * @return key value 数据字典 Map 集合
     */
    public static Map<String,Object> getMap(String code) {

        List<DataDictionaryVO> dataDictionaries = systemVariableService.getDataDictionaries(code);
        Map<String,Object> result = Maps.newHashMap();
        for (DataDictionaryVO data : dataDictionaries) {
            result.put(data.getCode(),data.getName());
        }
        return result;
    }

    public static DataDictionaryVO getDataDictionary(String code) {
    ...
    public static String getName(String code,Object value) {
        ...
        for (DataDictionaryVO dataDictionary : dataDictionaries) {
